    ...
    export default {
        ...
        methods: {
            ...
            checkInSwarm(key) {
                ...
                this.$axios.get(`https://api.martovariverside.com/api/oauth/foursquare/checkin?accessToken=${key}`).then((res) => {
        ...
        created() {
            this.$route.query.foursquare_key ? this.setCookie("foursquare_key", this.$route.query.foursquare_key, 20) : console.log('no fsqure key');
