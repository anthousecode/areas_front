<template>
    <section id="sales-wrapper">
        <div
            v-if="getWindowWidth > 1192"
            id="search-bar"
            class="search-bar d-flex justify-content-around align-items-center"
        >
            <notifications group="foo" position="center" />
            <button
                @click="filterByStatus('rgba(255, 72, 9, 0.4)')"
                class="status status-red"
            >
                {{ this.$options.filters.toUSD(language, "Sales") }}
            </button>
            <button
                @click="filterByStatus('rgba(250, 214, 29, 0.4)')"
                class="status status-yellow"
            >
                {{ this.$options.filters.toUSD(language, "Reserved") }}
            </button>
            <button
                @click="filterByStatus('rgba(4, 136, 25, 0.4)')"
            ...
            <client-only>
                <div class="inp-group">
                    ...
                    <input
                        ...
                        type="number"
                        :placeholder="`№ ${this.$options.filters.toUSD(
                            language,
                            'Участка'
                        )}`"
                    />
                ...
                <div class="d-flex justify-content-between header">
                    <div class="header-part header-part__left">
                        <p>
                            Паспорт
                            {{
                                this.$options.filters.toUSD(language, "Участка")
                            }}
                            № {{ currentRegion.otherInfo.number }}
                        </p>
                    </div>
                    <div>
                        <a @click="hideAll" href="#" id="closer"
                            ><img src="../static/closerModal.svg" alt="close"
                        /></a>
                    </div>
                </div>
                <hr class="p-0 mt-1" />
                <div class="base pt-2 d-flex flex-column">
                    ...
                    <div class="d-flex flex-grow-1">
                        <div class="left w-75">
                                ...
                                <div>
                                    <div class="d-flex list">
                                        ...
                                        <p class="p-description">
                                            <a
                                                class="kad-link"
                                                href="http://map.land.gov.ua/kadastrova-karta"
                                                target="_blank"
                                                >{{
                                                    currentRegion.otherInfo
                                                        .cad_number
                                                }}</a
                                            >
                                        </p>
                                    ...
                                    <div class="d-flex list">
                                        ...
                                        <p class="p-description">
                                            {{
                                                currentRegion.otherInfo.square
                                            }}
                                            га
                                        </p>
                                    </div>
                                    <div class="d-flex list">
                                        ...
                                        <p
                                            :style="{
                                                borderBottom: `2px solid ${currentRegion.modelView.stroke}`,
                                            }"
                                            class="p-description status"
                                        >
                                            {{
                                                language === "ru"
                            ...
                            <div
                                class="d-flex mt-3"
                                v-if="getWindowWidth >= 1190"
                            >
                                <turntable
                                    v-if="hideTurntable"
                                    :rotateCounter="rotateCounter"
                                    @setLastIndexToCounter="
                                        setLastIndexToCounter
                                    "
                                ...
                                <div class="pl-4">
                                    <p class="mb-2" style="color: black">
                                        {{
                                            this.$options.filters.toUSD(
                                                language,
                                                "Геодезическая съемкa"
                                            )
                                        }}
                                    </p>
                                    <div>
                                        <a
                                            :href="currentRegion.survey"
                                            class="save-link d-flex align-items-center"
                                            download
                                        >
                                            <img
                                                src="../static/dwg.svg"
                                        ...
                                        <a
                                            :href="currentRegion.plan"
                                            class="save-link d-flex align-items-center mt-3"
                                            download
                                        >
                                            <img
                                                src="../static/pdf.svg"
                                ...
                                <div
                                    class="model-controls d-flex justify-content-between"
                                >
                                    <div
                                        @mousedown="
                                            startTurntableMouseDown('left')
                                        "
                            ...
                            <div v-else class="position-relative">
                                <div style="width: 100%">
                                    <p class="mb-2 cad" style="color: black">
                                        {{
                                            this.$options.filters.toUSD(
                                                language,
                                                "Кадастровый план"
                                    ...
                                    >
                                        ...
                                        />
                                        <img
                                            src="../static/lupa1.svg"
                                            class="lupa_mob"
                                            alt="lupa"
                                        />
                                    </a>
                                    <a
                                        :href="foof(currentRegion)"
                                        target="_blank"
                                        class="save-link text-right"
        ...
        <div class="wrapper min-container" style="background-color: black">
            <img
                v-if="getWindowWidth <= 1113 && !isLoader"
                class="big-img min-container"
                id="bigImg3"
                src="/uchastki_top.jpg"
                alt="big"
            />
            <img
                v-else-if="getWindowWidth <= 1113 && isLoader"
                class="big-img min-container"
                id="bigImg3"
                src="/uchastki_top-min.jpg"
                alt="big"
            />
            <img
                v-else-if="getWindowWidth > 1113 && getWindowWidth <= 1280"
                style="object-fit: cover; transform: scale(1)"
                class="big-img min-container"
                id="bigImg3"
                src="/16801.jpg"
                alt="big"
            ...
            />
            <img
                v-else-if="getWindowWidth > 1681 && getWindowWidth < 1921"
                class="big-img min-container"
                id="bigImg2"
                src="/19201.jpg"
                alt="big"
            />
            <img
                v-else-if="getWindowWidth >= 1921 && getWindowWidth < 2800"
                class="big-img min-container"
                id="bigImg"
                src="/2048.jpg"
                alt="big"
...
export default {
    ...
    head: {
        script: [{ src: "https://api.martovariverside.com" }],
    },
    data: () => ({
        window: {},
        widthMap: 0,
    ...
    methods: {
        foof(foo) {
            let sas = foo.print_plan
                ? foo.print_plan.split("&export=download")[0]
                : "";
            return sas;
        },
        ...
        initData() {
            ...
            if (this.getWindowWidth <= 1281) {
                ...
                this.getWindowWidth > 1280 &&
                this.getWindowWidth < 1681 &&
                this.getWindowHeight < 978
            ) {
        ...
        initView() {
            ...
            window.scrollTo(
                document.documentElement.scrollWidth / 2 - width,
                document.documentElement.scrollHeight / 2 - height
            );
        },
        initActions() {
            d3.select("svg")
                ...
                .on("click", (d) => {
                    ...
                    this.$axios
                        .get(
                            `/upload-files-for-areas/${this.currentRegionId}/d6b2d6df-b269-4575-88bd-395bff78edd6`
                        )
                        .then((res) => {
        ...
        getWidthD3(name) {
            return Math.round(
                Number(d3.select(name).style("width").slice(0, -2))
            );
        },
        getHeightD3(name) {
            return Math.round(
                Number(d3.select(name).style("height").slice(0, -2))
            );
        },
        appendSvg() {
            this.elements.svg.d3El = d3
                .select("#map")
                .append("svg")
        ...
        appendScaleLiner() {
            this.elements.scaleLinerX = d3
                .scaleLinear()
                .domain([0, 1200])
                .range([0, this.widthMap]);
            this.elements.scaleLinerY = d3
                .scaleLinear()
                .domain([0, 675])
                .range([this.heightMap, 0]);
        },
        createPolygon(data) {
            d3.select("g")
                .selectAll("polygon")
                ...
                .append("polygon")
                .attr("points", (d) => {
                    return d.modelView.polygon
                        .map((d) => {
                            return [
                                this.elements.scaleLinerX(d.x),
                                this.elements.scaleLinerY(d.y),
                            ].join(",");
                        })
                        .join(" ");
                })
