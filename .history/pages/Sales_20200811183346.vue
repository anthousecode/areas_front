<template>
  <section id="sales-wrapper">
    <div v-if="getWindowWidth>1192" id="search-bar" class="search-bar d-flex justify-content-around align-items-center">
              ...
              <div class="d-flex">
                <div>
                  ...
                  <div class="d-flex list">
                    ...
                    <p :style="{borderBottom: `2px solid ${currentRegion.modelView.stroke}`}" class="p-description status">
...
<!--                      tofo $-->
              ...
              <div class="d-flex mt-3" v-if="getWindowWidth>=1190">
                <turntable
                  v-if="hideTurntable"
              ...
              <div v-else class="position-relative">
                <div style="width: 100%;">
                  <p class="mb-2 cad" style="color:black;">{{this.$options.filters.toUSD(language, 'Кадастровый план')}} </p>
                  <a :href="currentRegion.phone_plan" target="_blank" class="plan-img" style="position: relative">
                    <img :src="currentRegion.image" alt="plan">
                    <img src="../static/lupa1.svg" class="lupa_mob" alt="lupa">
                  </a>
            ...
            <div v-if="getWindowWidth>=1190" class="w-50 position-relative">
              <div style="width: 100%;">
    ...
    <div class="wrapper min-container" style="background-color: black">
      <img v-if="getWindowWidth<=1113&&!isLoader" class="big-img min-container" id="bigImg3" src="/uchastki_top.jpg"
           alt="big">
      <img v-else-if="getWindowWidth<=1113&&isLoader" class="big-img min-container" id="bigImg3" src="/uchastki_top-min.jpg"
           alt="big">
      <img v-else-if="getWindowWidth>1113 && getWindowWidth<=1280" style="object-fit: cover; transform: scale(1);"  class="big-img min-container" id="bigImg3"
           src="/16801.jpg" alt="big">
