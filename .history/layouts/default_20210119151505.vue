...
export default {
    ...
    mounted() {
        this.$bus.$on("changeZIndexVisible", this.zIndex);
        this.$bus.$on("removeZIndexVisible", this.zIndex);
    },
    beforeDestroy() {
        this.$bus.$off("changeZIndexVisible", this.zIndex);
        this.$bus.$off("removeZIndexVisible", this.zIndex);
    },
};
</script>
