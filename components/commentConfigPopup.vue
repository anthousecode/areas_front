    ...
    <form class="p-5" @submit.prevent="submitHandler">
        <div class="moda" tabindex="100" role="dialog">
            <div class="modal-dialog" role="document">
                ...
                >
                    ...
                    <div class="modal-body p-5 pb-0">
                        ...
                        <div class="form-group my-2">
                            ...
                            >
                                {{
                                    $options.filters.toUSD(language, "Удалить")
                                }}
                            </button>
                        </div>
                        <div class="form-group my-2">
                            <button
                                ...
                                id="editBtn"
                            >
                                {{ $options.filters.toUSD(language, "Отмена") }}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                />
                <editComment
                    :currentComment.sync="currentComment"
                    @closeModal="toggleEditComment"
                    v-if="isEditCommentVisible"
                />
            </div>
        </div>
    </form>
